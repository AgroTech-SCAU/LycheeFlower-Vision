...
MODEL_ID = "litchi_fruit_detect"
MODEL_VERSION = "v1.0"
COUNT_TARGET = "litchi_fruit"
SCHEMA_VERSION = 1
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="荔枝果实 YOLO 单图目标检测")
...
def main() -> int:
    ...
    print(f"检测完成：发现 {payload['raw_count']} 个荔枝果实目标")
